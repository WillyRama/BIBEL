...
import com.willyramad.bibel.service.ApiClient
import com.willyramad.bibel.service.ApiService
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response
import java.util.ArrayList

class JuzAmmaViewModel : ViewModel() {
    ...
    fun setSurah() {
        val apiService: ApiService = ApiClient.getQuran()
